...
function editAnimal(id) {
    ...
    .then(res=>res.text()).then(res=>{
        if(res=="Resource not found") {
            ...
            let responseParsedData = JSON.parse(res);
            elEditForm.querySelector(`[name='name']`).value=responseParsedData.name?responseParsedData.name:"No data";
            elEditForm.querySelector(`[name='category']`).value=responseParsedData.category?responseParsedData.category:"No data";
            elEditForm.querySelector(`[name='speed']`).value=responseParsedData.speed?responseParsedData.speed:"0";
            elEditForm.querySelector(`[name='soundText']`).value=responseParsedData.soundText?responseParsedData.soundText:"No data";
            elEditForm.querySelector(`[name='year']`).value=responseParsedData.year?responseParsedData.year:"0";
            elEditForm.querySelector(`[name='weight']`).value=responseParsedData.weight?responseParsedData.weight:"0";
            elEditForm.querySelector(`[name='color']`).value=responseParsedData.color?responseParsedData.color:"No data";
            elEditForm.querySelector(`[name='habitat']`).value=responseParsedData.habitat?responseParsedData.habitat:"No data";
            elEditForm.querySelector(`[name='isWild']`).value=String(responseParsedData.isWild)?String(responseParsedData.isWild):"true";
